...
(function () {
  ...
  var products = [
    { id: 1,  name: 'Bonix Rejuti Revo Serum',                              category: '세럼',   price: 1100,   rating: 4.8, popularity: 95, tags: ['Antioxidant', 'Deep Wrinkles'], img: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=600&q=70' },
    { id: 2,  name: 'Bonix Reju Revo Serum',                                category: '세럼',   price: 440000, rating: 4.7, popularity: 88, tags: ['Dry Skin Care', 'Skin Texture Care'], img: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=600&q=70' },
    { id: 3,  name: 'Bonix Hair Revo Serum',                                category: '세럼',   price: 440000, rating: 4.6, popularity: 72, tags: ['Scalp Soothing', 'Scalp Nourishment'], img: 'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?auto=format&fit=crop&w=600&q=70' },
    { id: 4,  name: 'Bonix Hugro Rico Cream',                               category: '크림',   price: 220000, rating: 4.9, popularity: 91, tags: [], img: 'https://images.unsplash.com/photo-1619994403073-2cec844b8e63?auto=format&fit=crop&w=600&q=70' },
    { id: 5,  name: 'Bonix Cure V',                                         category: '스텝',   price: 220000, rating: 4.5, popularity: 65, tags: [], img: 'https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?auto=format&fit=crop&w=600&q=70' },
    { id: 6,  name: 'Bonix Cure C',                                         category: '스텝',   price: 220000, rating: 4.7, popularity: 78, tags: ['Exfoliation', 'Blemish Care'], img: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&fit=crop&w=600&q=70' },
    { id: 7,  name: 'Bonix Hugro Peptide Mist',                             category: '미스트', price: 220000, rating: 4.4, popularity: 55, tags: ['Hydration'], img: 'https://images.unsplash.com/photo-1617897903246-719242758050?auto=format&fit=crop&w=600&q=70' },
    { id: 8,  name: 'The:st High-Concentrate Hugro W Raw Cosmetic (30ea)',  category: '화장품', price: 220000, rating: 4.3, popularity: 48, tags: ['Single Dose', 'Wrinkle Care'], img: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=600&q=70' },
    { id: 9,  name: 'Bonix Skin Essence',                                   category: '에센스', price: 180000, rating: 4.6, popularity: 82, tags: ['Moisturizing', 'Firming'], img: 'https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?auto=format&fit=crop&w=600&q=70' },
    { id: 10, name: 'Bonix Cell Repair Cream',                              category: '크림',   price: 350000, rating: 4.8, popularity: 90, tags: ['Regeneration', 'Soothing'], img: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=600&q=70' },
    { id: 11, name: 'Hugro Vital Essence',                                  category: '에센스', price: 280000, rating: 4.5, popularity: 70, tags: ['Vitality', 'Radiance'], img: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?auto=format&fit=crop&w=600&q=70' },
  ];
  ...
  function render() {
    ...
    switch (currentSort) {
      case 'name':       filtered.sort(function (a, b) { return a.name.localeCompare(b.name, 'en'); }); break;
